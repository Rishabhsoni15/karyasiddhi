  ...
  return (
    <div
      className={`fixed right-6 transition-all duration-[1200ms] ease-out ${
        visible
          ? "bottom-20 sm:bottom-6 opacity-100 animate-fallfromtop z-50 block"
          : "-top-20 opacity-0 animate-risetotop z-0 hidden"
      }`}
    >
      <div className="relative group w-12 h-12">
        <div className="absolute inset-0 bg-[#3fd017] rounded-xl animate-ripple" />
        <a
          href={whatsappLink}
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Contact us on WhatsApp"
          className="relative z-10 w-12 h-12 flex items-center justify-center rounded-xl bg-[#3fd017] text-white shadow-lg hover:scale-110 transition-transform"
        >
          <FaWhatsapp size={24} />
        </a>
      </div>
